...
const buildAppInventoryQuery = (baseUrl, adminDeviceSpaceId, deviceUuids) =>
  `${baseUrl}/api/v2/appinventory?adminDeviceSpaceId=${adminDeviceSpaceId}&deviceUuids=${deviceUuids.join(',')}`
 ...
 */
const createFullAppInventoryStream = (opts) => undefined

module.exports = {
  createAppInventoryOpts,
  buildAppInventoryQuery,
  getAppInventory,
  createFullAppInventoryStream
}
